...
| `app.json` Android permissions, versionCode, runtimeVersion | ✅ Configured | — |
| `app.json` iOS infoPlist usage descriptions | ✅ Configured | — |
| `eas.json` build/submit configuration | ✅ Configured | — |
| **App icon** (1024×1024 PNG) | ✅ Generated placeholder | Replace with designer asset before launch |
| **Adaptive icon foreground** (1024×1024, safe zone 432px) | ✅ Generated placeholder | Replace with designer asset before launch |
| **Splash screen** (1284×2778) | ✅ Generated placeholder | Replace if needed |
| **Play feature graphic** (1024×500) | ✅ Generated placeholder | Replace with designer asset before launch |
| **Privacy policy URL** | ✅ Hosted at `/api/legal/privacy` | — |
| **Terms of Service URL** | ✅ Hosted at `/api/legal/terms` | — |
| **Phone screenshots** (≥ 2, 1080×1920 or 16:9) | ❌ MISSING | You — build APK & capture |
...
> **Brand asset regen:** all placeholder PNGs in `/app/mobile/assets/` were generated by `/app/scripts/generate_mobile_assets.py`. Re-run after replacing the script's colors/typography, or — better — drop in designer-made files of the same dimensions.

> **Privacy / Terms URLs live now:**
> - `https://<your-public-domain>/api/legal/privacy`
> - `https://<your-public-domain>/api/legal/terms`
> These are required fields on the Play Console "App content → Privacy policy" page. They serve a styled HTML page with brand colors and are cacheable for 1 hour. Both `.txt` versions (`/api/legal/privacy.txt`) are also available for compliance archiving.
